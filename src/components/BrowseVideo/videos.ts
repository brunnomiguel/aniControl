import OnePiece from "../../assets/video/One-Piece.mp4";
import Kiznaiver from "../../assets/video/Kiznaiver.mp4";
import DeathNote from "../../assets/video/Death-Note.mp4";
import Naruto from "../../assets/video/NarutoShippuden.mp4";
import ShamanKing from "../../assets/video/SHAMAN-KING.mp4";
import Kimetsu from "../../assets/video/Kimetsu-no-Yaiba.mp4";
import BlueExorcist from "../../assets/video/Blue-Exorcist.mp4";
import HunterXHunter from "../../assets/video/Hunter-X-Hunter.mp4";
import PlasticMemories from "../../assets/video/Plastic-Memories.mp4";
